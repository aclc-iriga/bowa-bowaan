...
const EVENTS = [
    [
        'slug'    => 'datu-topas-dayang-laypani-showdown',
        'percent' => 60
    ],
    [
        'slug'    => 'datu-topas-dayang-laypani',
        'percent' => 40
    ]
];

// initialize titles
$titles = ['Datu Topas and Dayang Laypani 2025'];
...
<head>
    ...
    <title><?php if(sizeof($titles) > 1) { ?>  Top <?= sizeof($titles) ?> <?php } else { ?> <?= $titles[0] ?>  <?php } ?> | <?= $competition_title ?>  </title>
</head>
<body>
...
<div class="p-1">
    <table class="table table-bordered result">
        ...
        <tr class="table-secondary">
            <th colspan="3" rowspan="3" class="text-center bt br bl bb">
                <h1 class="m-0"><?php if(sizeof($titles) > 1) { ?>  Top <?= sizeof($titles) ?> <?php } else { ?> <?= $titles[0] ?>  <?php } ?></h1>
                <h5 class="mt-3"><?= $competition_title ?></h5>
            </th>
    ...
    <div class="container-fluid mt-4 pb-2">
        <div class="row justify-content-center">
            <?php foreach((new Event(4))->getAllJudges() as $judge) { ?>
